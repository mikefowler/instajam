...
describe("Instajam", function() {
  ...
  API = null;
  CLIENT_ID = 'e9c4567d05174f47827a022e31aeffd4';
  ...
  return it("should return a proper authentication URL", function() {
    ...
    return expect(auth_url).toEqual("https://instagram.com/oauth/authorize/?client_id=" + CLIENT_ID + "&redirect_uri=" + REDIRECT_URI + "&response_type=token");
  });
});
