(function() {
  ...
  window.Instajam = (function() {
    ...
    User.prototype.lookup = function(username, callback) {
      return User.prototype.search.call(this, username, null, function(result) {
    ...
    request = function(options) {
      var callbackName, queryString, script, url_base, _ref;
    ...
    InstajamError = function(message) {
      ...
      return this.message = message != null ? message : '';
    };
